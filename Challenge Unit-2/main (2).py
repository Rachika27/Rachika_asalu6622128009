...
deposit money, withdraw money, and display the account balance.Enure that the account balance
  ...
  def withdraw(self, amount):
    if amount > 0 and amount <= self.__account_balance:
     ...
     print("Withdraw ₹{} . New balance: ₹{}".format(amount,self.__account_balance))
      ...
      print("Invalid withdraw amount or insufficien balance.")

  def display_balance(self):
    print("Account balance for {} (Account #{}): ₹{}".format(self.__account_number_holder_name, self.__account_number,self.__account_balance))
